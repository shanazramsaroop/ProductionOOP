...
public class AudioPlayer extends Product implements MultimediaControl {
    ...
    /**
     * Class constructor specifying the manufacturer, name, supportedAudioFormats and supportedPlaylistFormats
     ...
     */
    public AudioPlayer(String manufacturer, String name, String supportedAudioFormats, String supportedPlaylistFormats) {
     ...
     *
     * @return a string containing the audio player's supported audio formats and supported playlist formats
     */
    ...
    /**
     * Adds an audio player and a movie player to an array list named productList of type MultimediaControl
     */

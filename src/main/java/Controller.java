  ...
  public void connectToProd() {
    ...
    try {
      ...
      PreparedStatement pstmt = conn
          .prepareStatement("INSERT INTO Product( type, manufacturer, name) " +
              "VALUES ( ?, ? , ?)");
  ...
  public void addToProductionDB(ArrayList productionRun) {
    ...
    for (int i = 0; i < productionRun.size(); i++) {
      ...
      try {
        ...
        //STEP 3: Execute a query
        PreparedStatement pstmt = conn
            .prepareStatement("INSERT INTO ProductionRecord(" +
        ...
        pstmt.setInt(1, productRec.getProductID());
        pstmt.setString(2, productRec.getSerialNum());

        //format date:
        pstmt.setDate(3, new java.sql.Date(productRec.getProdDate().getTime()));
  ...
  public void loadProductionLog() {
    ...
    try {
      ...
      while (rs.next()) {
        ...
        prodDate = rs.getTimestamp(4);

        ProductionRecord record = new ProductionRecord(prodNum, prodID, serialNum, prodDate);

...
public class Employee {
  ...
  /**
   * Sets the username field to the first initial of the first name and then the last name of this
   * production record.
   *
  ...
  /**
   * Sets the email field to the first name, then a period, then the last name followed by
   * @oracleacademy.Test
   *
   * @param name This Production record's production number.
   */
  ...
  /**
   * Checks to see if the password contains a lowercase letter, uppercase letter, and a special
   * character
   *

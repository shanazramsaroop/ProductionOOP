...
public class ProductionRecord {
    ...
    ProductionRecord(Product product) {
        ...
        this.serialNum = product.manufacturer.substring(0, 3) + product.type.code + String.format("%05d", 0);
    ...
    public String toString() {
        ...
        return "Prod. Num: " + prodNum + " Product Name: " + prodID + " Serial Num: " + serialNum + " Date: " + dateProduced;
